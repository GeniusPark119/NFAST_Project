...
const TicketCoIcon = styled.svg`
  ...
  height: auto;
`;
const TicketCoName = styled.span`
  font-size: 2.5em;
  font-variation-settings: "wght" 500, "wdth" 75;
  letter-spacing: -0.01em;
`;
const TicketCoSubName = styled.span`
...
const TicketTiming = styled.div`
  ...
  text-align: left;
`;
const TicketSmallLabel = styled.span`
  display: block;
  margin-bottom: 0.5em;
  font-variation-settings: "wght" 300;
  font-size: 0.875em;
...
const TicketDetail = styled.span`
  ...
  color: #424f5e;
`;
const TicketFinePrint = styled.p`
  margin-top: 1rem;
  font-variation-settings: "wdth" 75;
  color: #666;
`;
const TicketAdmit = styled.p`
  margin-top: 2rem;
  font-size: 2.5em;
...
const TicketBarcode = styled.img`
  margin-top: 1.25em;
  width: 299px;
  max-width: 100%;
`;
        ...
        <Ticket aria-hidden="true">
          <TicketHeader>
            <TicketCo>
              ...
              <TicketCoName>Variable Tides</TicketCoName>
              <TicketCoSubName class="u-upper">
                Boating Adventures
              </TicketCoSubName>
            </TicketCo>
          </TicketHeader>
          <TicketBody>
            <TicketRoute>Winter Wonderland</TicketRoute>
            <TicketDescription>
              A four-hour tour of the Strait of Garamond
            </TicketDescription>
            <TicketTiming>
              <p>
                <TicketSmallLabel class="u-upper">Date</TicketSmallLabel>
                <TicketDetail>Feb 27</TicketDetail>
              </p>
              <p>
                <TicketSmallLabel class="u-upper">Launch</TicketSmallLabel>
                <TicketDetail>10:30 am</TicketDetail>
              </p>
              <p>
                <TicketSmallLabel class="u-upper">Boarding</TicketSmallLabel>
                <TicketDetail>10:00 am</TicketDetail>
              </p>
            </TicketTiming>
            <TicketFinePrint>
              This ticket cannot be transferred to another voyage
            </TicketFinePrint>
            <TicketAdmit class="u-upper">Admit one adult</TicketAdmit>
            <TicketBarcode
...
export default FloatingCodePen;
